...
+ Royston-Sauerbrei D statistic and R<sup>2</sup><sub>D</sub>;  
...
source(here::here("R/royston_R2D_cmprsk.R"))
```

```{r, royston_R2D, fig.align='center'}
# Models ----------
fit_csh <- CSC(Hist(time, status_num) ~ 
                 age + size +
                 ncat + hr_status, 
