...
2. To assess the performance of the model in terms of calibration, discrimination and overall prediction error. We calculate the apparent (not the true internal) validation and the external validation.
