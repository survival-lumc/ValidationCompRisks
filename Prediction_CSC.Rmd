...
```{r, num_cal_pseudo, fig.align='center',warning=FALSE,message=FALSE}
...
```{r, plot_sd, fig.align='center',warning=FALSE,message=FALSE}
# Models ----------
fit_csh <- CSC(Hist(time, status_num) ~ 
                 age + size +
                 ncat + hr_status, 
...
```{r, oe_ratio, fig.align='center',warning=FALSE,message=FALSE}
...
```{r, cal_intslope_pseudo, fig.align='center',warning=FALSE,message=FALSE}
...
```{r, function_D, message=FALSE,warning=FALSE, echo=FALSE}
# function to calculate D and R2D
source(here::here("R/roystonD.R"))
```

```{r, royston_R2D, fig.align='center', message=FALSE, warning=FALSE}
# Models ----------
fit_csh <- CSC(Hist(time, status_num) ~ 
                 age + size +
                 ncat + hr_status, 
...
```{r, function_dca, message=FALSE,warning=FALSE, echo=FALSE}
