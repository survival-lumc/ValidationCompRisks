...
To get further insight into the effect of the predictors, we plot the  values of the observed predictors in the validation set against the estimated absolute risk of breast cancer recurrence at 5 years. This gives an idea of the size of the effects.
